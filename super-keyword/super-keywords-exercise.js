...
var polo = new Car("Polo", "Volks Wagen", 2015, 4);

polo.toString(); // "The make, model, and year are Polo Volks Wagen 2015"
polo.start(); // "VROOM!"

// console.log(polo); //Car {make: "Polo", model: "Volks Wagen", year: 2015, numWheels: undefined}
...
var moto = new Motorcycle("Harley", "Mercedes", 2017);
moto.numWheels; //2
