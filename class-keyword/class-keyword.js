...
class Person {
  ...
  multiplyFavoriteNumber(times){ 
  return this.favoriteNumber * times;
  }
}

var person = new Person("Misael", "Calvillo", "purple", 50);
var answer = person.multiplyFavoriteNumber(10); // 500
